...
import com.ntpro.mobileandroiddevtestwork.presentation.MainActivity;
import com.ntpro.mobileandroiddevtestwork.presentation.MainActivityViewModel;
import com.ntpro.mobileandroiddevtestwork.presentation.MainActivityViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.mainActivityViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.ntpro.mobileandroiddevtestwork.presentation.MainActivityViewModel", ((Provider) mainActivityViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ntpro.mobileandroiddevtestwork.presentation.MainActivityViewModel 
          return (T) new MainActivityViewModel(singletonCImpl.networkRepository());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private Provider<Server> providesServerProvider;
    ...
    private NetworkRepository networkRepository() {
      return AppModule_ProvidesNetworkRepositoryFactory.providesNetworkRepository(providesServerProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize() {
      this.providesServerProvider = DoubleCheck.provider(new SwitchingProvider<Server>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ntpro.mobileandroiddevtestwork.data.network.Server 
          return (T) AppModule_ProvidesServerFactory.providesServer();
